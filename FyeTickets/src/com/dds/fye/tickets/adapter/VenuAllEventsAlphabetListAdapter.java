...
public class VenuAllEventsAlphabetListAdapter extends BaseAdapter{

    public static abstract class Row_S {}
    
    public static final class Section_S extends Row_S {
        public final String text;

        public Section_S(String text) {
            this.text = text;
        }
    }
    
    public static final class Item_S extends Row_S {
        public final String text;
        public final EventsData eventsData;
        public Item_S(String text, EventsData eventsData) {
            this.text = text;
            this.eventsData = eventsData;
        }
    }
    
    private List<Row_S> rows;
    
    public void setRows(List<Row_S> rows) {
        this.rows = rows;
    }
    ...
    @Override
    public Row_S getItem(int position) {
    ...
    public int getItemViewType(int position) {
        if (getItem(position) instanceof Section_S) {
            return 1;
        } else {
            return 0;
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (getItemViewType(position) == 0) { // Item
           ...
           // }
            ...
            Item_S item = (Item_S) getItem(position);
           ...
           // final ImageView favoriteArtist = (ImageView)view.findViewById(R.id.favorite_imageView1);
            ToggleButton favoriteArtistToggleButton = (ToggleButton)view.findViewById(R.id.favorite_ToggleButton);
			...
			String event_venue_address = hashMapData.localEventAddress;
		   ...
		   // int dd =  Integer.parseInt(dateNumber[2]); 
		    ...
		    String address = event_venue_address+","+event_venue_location;
		    ...
		    addresstextView.setText(completDateAndTime);
		    dateTimeInfotextView.setText(address);
		    if (weekendFlag == 0) {
...
/*		    if (fav_temp) {
           ...
           // }
            ...
            Section_S section = (Section_S) getItem(position);
