...
public class ArtistTeamsAlphabetListAdapter extends BaseAdapter implements Filterable{
	        ...
	        if (getItemViewType(position) == 0) { // Item
	          ...
	          //  final ImageView favoriteArtist = (ImageView)view.findViewById(R.id.favorite_imageView1);
			   ...
			   // int dd =  Integer.parseInt(dateNumber[2]); 
			    ...
			    //Log.e("ArtistTeamsEventslist", "month:"+month);
			    //Log.i("ArtistTeamsEventslist", " day_no_day:"+day_no_day);
			   // Log.d("ArtistTeamsEventslist", " day_no_day:"+day_no_day);
			    ...
			    favoriteArtistToggleButton.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						if (favoriteArtistToggleButton.isChecked()) {
							...
							favoriteArtistToggleButton.setChecked(false);
							db.addContact(hashMapData,"artist_teams");
						}
					}
				});
	               ...
	               // Log.e("VALUES", "getCount():"+getCount());
	                for (int i = 0; i < getCount(); i++) {
	                	try {
	                		...
	                		EventsData hashMapData = item.eventsData;//venueData;
