...
public class TwitterShare  extends Activity{
     ...
     * */
    static String TWITTER_CONSUMER_KEY = "qFj9SLIX7Iqm8b4SOuwPA";
    static String TWITTER_CONSUMER_SECRET = "OAZBhXal5bIJAKdGMrTJnVeqLdXSdvNsNX6VUae0H0I";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tweet_share);
        ...
        if(TWITTER_CONSUMER_KEY.trim().length() == 0 || TWITTER_CONSUMER_SECRET.trim().length() == 0){
            // Internet Connection is not present
            alert.showAlertDialog(TwitterShare.this, "Twitter oAuth tokens", "Please set your twitter oauth tokens first!", false);
            // stop executing code by return
            return;
        }
    ...
    private void updateStatus(){
    	  new updateTwitterStatus().execute("hi hari");
